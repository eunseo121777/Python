...
plt.figure(figsize=(5,3))
plt.plot(months,num_cases,label='nuimber of cases')
plt.plot(months,cum_cases,label='cumulative cases')
plt.xlabel('month')
plt.legend()
plt.show()
...
plt.figure(figsize=(5,3))
plt.bar(ind-w/2,boy,color='b',label='boy',width=w)
plt.bar(ind+w/2,girl,color='r',label='girl',width=w)
plt.xticks(ind,year)
plt.legend()
plt.xlabel('year')
